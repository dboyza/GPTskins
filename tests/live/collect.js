...
function collectGPTskinsAudit(options = {}) {
  const definitions = [
    ...
    ['settings-panel', '[role="dialog"] [role="tabpanel"][data-state="active"]'],
    ['usage-meter', '[role="tabpanel"][id$="-Usage"] :is(.bg-token-bg-tertiary, .bg-token-text-primary)'],
    ['usage-countdown', '[role="tabpanel"][id$="-Usage"] button.decoration-dotted'],
    ['usage-action', '[role="tabpanel"][id$="-Usage"] button.btn-secondary'],
    ['plugin-icon', '[role="tabpanel"][id$="-Plugins"] [data-testid="plugin-icon-wrapper"]'],
    ['switch', '[role="switch"]'],
