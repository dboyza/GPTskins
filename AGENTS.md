...
- Current suggestion list markup can be `form.group/composer ... [class*="top-full"] > ul.divide-token-border-light > li`; style that composer-local `top-full`/`divide-token-border` surface directly.
