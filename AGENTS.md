...
- The bottom account row is `data-testid="accounts-profile-button"` and should keep its hover/open highlight. Put that exception after the Recents/Pinned transparent trailing-button rules.
