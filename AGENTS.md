...
- Current suggestion list markup can be `form.group/composer ... [class*="top-full"] > div.bg-surface-primary > ul.divide-token-border-light > li`; style that composer-local parent, `top-full`, and `divide-token-border` surface directly.
