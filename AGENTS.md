...
- Sidebar `Pinned`/`Recents` headers should not get hover pills. Keep section-header controls and icon-only sibling action buttons/wrappers transparent; normal chat rows can still hover.
