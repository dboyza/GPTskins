...
- CodeMirror email/message snippets use `.pe-11` to reserve copy-button gutter space. If the inner rounded editor line stops short, extend `.cm-editor` by `2.75rem` inside `.pe-11.pt-3`, do not restyle normal code blocks.
